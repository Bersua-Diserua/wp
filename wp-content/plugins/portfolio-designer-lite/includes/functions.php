...
if (!function_exists('pdl_get_social_icons')) {
    ...
    function pdl_get_social_icons($data_setting, $current_page_id, $position = 0 ) {
        ...
        if (($data_setting['portfolio_facebook_link'] == 1) || ($data_setting['portfolio_twitter_link'] == 1) || ($data_setting['portfolio_linkedin_link'] == 1) ||
...
function pdl_get_content_position() {
    ob_start();
    $portfolio_overlay = (isset($_POST['overlay']) && $_POST['overlay'] != '') ? esc_attr($_POST['overlay']) : 'enable';
    ...
    <td>
        ...
        <div class="select-cover">
            <select id="portfolio_content_position" name="portfolio_content_position">
                <?php if($portfolio_overlay == 'enable'){ ?>
                    <option value="overlay_image" <?php echo ($portfolio_content_position == 'overlay_image') ? 'selected="selected"' : ''; ?>><?php _e('Overlay on Image', 'portfolio-designer-lite'); ?></option><?php
                } ?>
                
                <option value="bottom_image" ><?php _e('Bottom of Image', 'portfolio-designer-lite'); ?></option>
                <option value="left_side" ><?php _e('Left side of Image', 'portfolio-designer-lite'); ?></option>
                <option value="right_side" ><?php _e('Right side of Image', 'portfolio-designer-lite'); ?></option>
            </select>
        </div>
    </td>
    <?php
