...
" data-show="portdesignstyle">
				...
				<div id="portdesigngeneral" <?php if ( $current_tab == 'portdesigngeneral' ) { echo ' style="display: block;"';} ?> class="postbox postbox-with-fw-options pdltab">
					<div class="inside">
						<table>
							<tbody>
								<tr>
								...
								<tr>
								<td>
									<label for="portfolio_delete_plugins_data"><?php _e( 'Delete data on deletion of plugin', 'portfolio-designer-lite' ); ?></label>
								</td>
								<td>
									<label class="desc_checkbox">
										<input id="portfolio_delete_plugins_data" name="portfolio_delete_plugins_data" type="checkbox" value="1" <?php echo ( isset( $portfolio_setting['delete_plugins_data'] ) && $portfolio_setting['delete_plugins_data'] == 1 ) ? 'checked="checked"' : ''; ?>/>
										<?php _e( 'Delete data on deletion of plugin', 'portfolio-designer-lite' ); ?>
									</label>
								</td>
							</tr>
							</tbody>
								...
								<td>
									...
									<div class="select-cover">
										<select id="portfolio_content_position" name="portfolio_content_position">
											<?php if(( isset( $portfolio_setting['enable_overlay'] ) && $portfolio_setting['enable_overlay'] == 1 )) { ?>
 ...
 class="postbox postbox-with-fw-options pdltab">
					<div class="inside">						
						...
						<table>
							...
							<tr>
								...
								<td>
									...
									<textarea class="widefat textarea" name="portfolio_custom_css" id="portfolio_custom_css" placeholder=".class_name{ color:#ffffff }"><?php echo wp_unslash($custom_css); ?></textarea>
								</td>
							</tr>
						</table>
						<div class="section-seprator"></div>
						...
						<table>
							...
							<tr>
								<td>
									<label for="portfolio_button_font_color"><?php _e( 'Button Icon Color', 'portfolio-designer-lite' ); ?></label>
								</td>
								<td>
